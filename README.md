...
2.	Place the two files in one package using your preferred IDE (e.g. NetBeans, Eclipse or visual studio code) and run the tool. 
3.	Start using the tool as the following guide section suggests. 
### CLI
### Troubleshooting 
